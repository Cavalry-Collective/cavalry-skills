...
4. Tell the user how to use it: **drag any card into another cell** to re-slice its phase/activity, and drop above/below other cards to rank it; **drag a phase rail or activity header** onto another to reorder rows/columns; double-click text to edit; hover a card for ⌗ (tags) / ×; **＋ Phase / ＋ Activity** to grow it; **Copy JSON / Download** to save the new arrangement (they can paste it back so you regenerate the downstream plan/tasks), **Import** to load a saved one, **Reset** to restore the original; the **中文 / EN** button toggles the UI language.
