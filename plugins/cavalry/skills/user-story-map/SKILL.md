...
4. Tell the user how to use it: **drag any card into another cell** to re-slice its phase/activity, and drop above/below other cards to rank it; **drag a phase rail or activity header** onto another to reorder rows/columns (the whole column/row slides live while dragging; a ⠿ grip shows on hover — top of a column, left of a rail); double-click text to edit; hover a card for ⌗ (tags) / ×; the dashed **＋ story / ＋ activity / ＋ phase** buttons in the grid grow it; **Copy to Clipboard** exports the new arrangement (they can paste it back so you regenerate the downstream plan/tasks) and **Import** loads a saved one; the **EN | 中文** toggle at the top right switches the UI language.
